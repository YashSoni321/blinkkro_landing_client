...
export const metadata: Metadata = {
  title: "KartSquare Waitlist Page - Join Early Access | Be First to Experience Premium Services",
  description: "Join KartSquare's exclusive waitlist and be among the first to access India's most trusted service platform. Get early access, special discounts, and priority booking.",
  keywords: [
    "KartSquare waitlist",
  ...
  openGraph: {
    ...
    description: "Be among the first to experience India's most trusted service platform. Join our waitlist for early access and exclusive benefits.",
  ...
  twitter: {
    ...
    description: "Be first to access India's most trusted service platform. Join waitlist for exclusive benefits and priority booking.",
