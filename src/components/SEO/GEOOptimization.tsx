      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": `KartSquare is India's leading service booking platform that connects customers with verified professionals for home services including ${services.join(', ')}. We serve customers across ${location} with same-day booking and transparent pricing.`
          }
        },
        {
          "@type": "Question", 
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": `KartSquare offers comprehensive home services including ${services.join(', ')}, and many more. All services are provided by verified and trained professionals with transparent pricing and quality guarantee.`
          }
        }
      ]
    };
