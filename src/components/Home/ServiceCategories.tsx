      ...
      <div className="container max-w-8xl mx-auto px-5 2xl:px-0">
        <div className="text-center mb-16">
          <div className='flex gap-2.5 items-center justify-center mb-3'>
            <Icon icon={'ph:wrench'} width={20} height={20} className='text-primary' />
            <p className='text-base font-semibold text-dark/75 dark:text-white/75'>Service Categories</p>
          </div>
              ...
              <div className="p-8 border border-black/10 dark:border-white/10 rounded-2xl hover:border-primary/50 transition-all duration-300 hover:shadow-lg">
                <div className="flex items-center gap-4 mb-4">
                  <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                    <Icon icon={category.icon} width={24} height={24} className="text-primary" />
                  </div>
                  <div>
