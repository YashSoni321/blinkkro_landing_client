      ...
      <div className="container max-w-8xl mx-auto px-5 2xl:px-0">
        <div className="text-center mb-16">
          <div className='flex gap-2.5 items-center justify-center mb-3'>
            <Icon icon={'ph:crown'} width={20} height={20} className='text-primary' />
            <p className='text-base font-semibold text-dark/75 dark:text-white/75'>Featured Services</p>
          </div>
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    <div className="flex items-center gap-1">
                      {[...Array(5)].map((_, i) => (
                        <Icon 
                          key={i}
                          icon={i < Math.floor(service.rating) ? 'ph:star-fill' : 'ph:star'} 
                          width={16} 
                          height={16} 
