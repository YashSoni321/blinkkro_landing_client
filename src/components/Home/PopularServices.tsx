      ...
      <div className="container max-w-8xl mx-auto px-5 2xl:px-0">
        <div className="text-center mb-16">
          <div className='flex gap-2.5 items-center justify-center mb-3'>
            <Icon icon={'ph:star'} width={20} height={20} className='text-primary' />
            <p className='text-base font-semibold text-dark/75 dark:text-white/75'>Popular Services</p>
          </div>
                ...
                <div className="p-6">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="flex items-center gap-1">
                      <Icon icon={'ph:star-fill'} width={16} height={16} className="text-yellow-400" />
                      <span className="text-sm font-medium text-dark dark:text-white">{service.rating}</span>
                    </div>
                    <span className="text-sm text-dark/50 dark:text-white/50">({service.reviews} reviews)</span>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-dark/50 dark:text-white/50">{service.duration}</span>
